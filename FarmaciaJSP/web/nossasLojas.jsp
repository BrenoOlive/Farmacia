...
<body>
    ...
    <section class="cxLoja1">
        <h3>Loja 1</h3>
        <p>
            Atendimento: todos os dias da semana, das 7h00 às 22h00.<br>
            Endereço: Rua. Alexander Bain, 866 - Jardim Nordeste - São Paulo/SP.<br>
    ...
    <section class="cxLoja2">
        ...
        <p>
            Atendimento: todos os dias da semana, das 7h00 às 22h00.<br>
            Endereço: Rua. Orville Derby, 430 - Mooca - São Paulo/SP.<br>
            Telefone: (00) 0000-0000
        </p>
        <hr>
    </section>
    ...
    <section class="cxLoja3">
        ...
        <p>
            Atendimento: todos os dias da semana, das 7h00 às 22h00.<br>
            Endereço: Rua. Aparecida Campanhola Parra, 192 - Vila Invernada - São Paulo/SP.<br>
            Telefone: (00) 0000-0000
        </p>
        <hr>
    </section>
    ...
    <section class="cxLoja4">
        ...
        <p>
            Atendimento: todos os dias da semana, das 7h00 às 22h00.<br>
            Endereço: Rua. Senador Elói de Souza, 115 - Vila Silvia - São Paulo/SP.<br>
            Telefone: (00) 0000-0000
        </p>
        <hr>
    </section>
    ...
    <section class="cxLoja5">
        ...
        <p>
            Atendimento: todos os dias da semana, das 7h00 às 22h00.<br>
            Endereço: Rua. Luta Popular, 365 - Saúde - São Paulo/SP.<br>
            Telefone: (00) 0000-0000
        </p>
        <hr>
    </section>
    <span class="tituloMap">Veja qual de nossas Lojas fica mais proxima de você:</span>
